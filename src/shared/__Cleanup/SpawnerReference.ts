...
export enum ESpawnerInstance {
	...
	Loot_Rare = "SPAWNER_Loot_Rare",
	Loot_Epic = "SPAWNER_Loot_Epic",
	Loot_Legendary = "SPAWNER_Loot_Legendary",
	Contraption = "SPAWNER_Contraption",
	Trap = "SPAWNER_Trap",
	Hazard_Poison = "SPAWNER_Hazard_Poison",
