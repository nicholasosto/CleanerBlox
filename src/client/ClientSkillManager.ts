...
export class ClientSkillManager {
	// eslint-disable-next-line prettier/prettier
	private static _slotsFrame = Players.LocalPlayer.WaitForChild("PlayerGui").FindFirstChild("ActionBarSlots",	true) as Frame;
    ...
    public static _connectionGetSkillInventory = event_SkillInventoryRequest.OnClientEvent.Connect((data: Array<string>) => {
			...
			ClientSkillManager._skillsInventoryScrollingFrame
				.GetChildren()
